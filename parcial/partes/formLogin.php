    ...
    <div id="formLogin" class="container">
      ...
      <form  class="form-ingreso " onsubmit="validarLogin();return false;">
        <h2 class="form-ingreso-heading">Ingrese su CUENTA</h2>
                ...
                <input type="text" id="correo" class="form-control" placeholder="Correo" required="" autofocus="" value="<?php  if(isset($_COOKIE["correo"])){echo $_COOKIE["correo"];}?>">
                <label for="clave" class="sr-only">Clave</label>
                <input type="password" id="clave" class="form-control" placeholder="Clave" required="" autofocus="" value="<?php  if(isset($_COOKIE["clave"])){echo $_COOKIE["clave"];}?>">
        <div class="checkbox">
          <label>
